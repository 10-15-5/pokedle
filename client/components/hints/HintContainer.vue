<template>
    ...
    >
        <p v-if="guessesRemainingForHint > 0" class="gap-2 p-2 px-3 sm:p-1">
            Guess <b class="text-light-orange dark:text-dark-orange"> {{ guessesRemainingForHint }} </b> more times for a HINT
        </p>
        <div v-else class="flex w-full flex-row items-center justify-between gap-2 p-2 px-3 pb-1 sm:p-1">
